...
class ITC_FlickrCN(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.preprocessed):
            ...
            train_file = os.path.join(self.dataset_dir, "flickr30k_cn_train.json")
            val_file = os.path.join(self.dataset_dir, "flickr30k_cn_val.json")
            test_file = os.path.join(self.dataset_dir, "flickr30k_cn_test.json")
